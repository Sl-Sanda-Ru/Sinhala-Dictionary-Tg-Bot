    ...
    [
        [
            InlineKeyboardButton(
                "Repo 🌎",
                url="https://github.com/Sl-Sanda-Ru/Sinhala-Dictionary-Tg-Bot",
            ),
            InlineKeyboardButton(
                "Contact Dev 🧑", url="https://t.me/Sl_Sanda_Ru"),
        ]
    ]
)
...
ALL_LANGS_KEYBOARD_DIS = InlineKeyboardMarkup(
    [[InlineKeyboardButton("🚫 Disable", callback_data="dis")]]
)
ALL_LANGS_KEYBOARD_ENA = InlineKeyboardMarkup(
    [[InlineKeyboardButton("✅ Enable", callback_data="ena")]]
)
ALL_LANGS_KEYBOARD_DIS_SIN = InlineKeyboardMarkup(
    [[InlineKeyboardButton("🚫 අක්‍රීය කරන්න", callback_data="dis")]]
)
ALL_LANGS_KEYBOARD_ENA_SIN = InlineKeyboardMarkup(
    [[InlineKeyboardButton("✅ සක්‍රීය කරන්න", callback_data="ena")]]
)
...
BROAD_SENT = "✅ Broadcasted To {} Users"
NO_BROAD = "Only Admin Can Use This Command 🤨"
NOT_REPLIED = "🚫 Please Reply To The Message You Want To Forward"
